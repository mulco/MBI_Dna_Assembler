...
public class SequenceBuilder {
	public static String build(final List<String> eulerPath) {
	...
	private static String concatSequences(final String base, final String next) {
		// System.out.println("CCT: "+base+", "+next);
		for (int i = next.length(); i > 0; i--) {
			// System.out.println("concatSequences: "+base.substring(base.length()-i,
			// base.length())+" + "+next.substring(0, i));
			if (base.substring(base.length() - i, base.length()).equals(
					next.substring(0, i))) {
